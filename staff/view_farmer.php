...
<table>
    ...
    foreach ($results as $row){
       ...
       $cow_name=$row['name'];
        $action1=$recommendation==false?"":"<a class='btn btn-success' style='background-color: deepskyblue' href='view_recommendations.php?id=$id&cow_name=$cow_name'>View Recommendations</a>";
